...
class LoginPage extends Component {
  ...
  FullName = () => {
    if (this.state.FullName == this.state.EnteredName) {
      ...
      this.setState({NameError: 'Please enter a Valid Email'});
    }
  };
  CheckEmail = () => {
  ...
  FinalValidator = () => {
    if (
      this.state.EnteredEmail == this.state.email &&
      this.state.EnteredPassword == this.state.password
    ) {
      ...
      <View>
        ...
        <View>
          ...
          <View style={styles.placeholder}>
            <ImageScreen
              ...
              Name={require('../AssetImage/User.jpeg')}
            />
            <TextInputComponent
        ...
        <View>
          ...
          <View style={styles.placeholder}>
            <ImageScreen
              style={styles.iconpass}
              Name={require('../AssetImage/msg.jpeg')}
            />
            <TextInputComponent
        ...
        <View style={{flexDirection: 'row'}}>
          <View style={styles.placeholder}>
            ...
            <TouchableOpacity
              ...
              <ImageScreen
                style={styles.iconpass}
                Name={require('../AssetImage/passwordeye.jpeg')}
              />
            </TouchableOpacity>
          </View>
        </View>
        ...
        <TextInputComponent
          ...
          style={styles.placeholderAddress}
        />
        <TextInputComponent
